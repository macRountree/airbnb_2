...
const Header = () => {
  ...
  return (
    <header className="sticky top-0 z-50 grid grid-cols-3 bg-white  shadow-md p-5 md:px-10">
      ...
      <div
        className="flex items-center md:border-2 rounded-full py-2 md:shadow-sm hover:md:shadow-lg
      "
      >
        <input
          value={searchInput}
          ...
          name="search"
          id=""
          placeholder="Start your search (only typing London"
        />
        <svg
          xmlns="http://www.w3.org/2000/svg"
          viewBox="0 0 24 24"
          fill="currentColor"
          className=" hidden lg:inline-flex h-8 bg-red-400 hover:bg-red-600 text-white rounded-full p-2 cursor-pointer md:mx-2 "
        >
          <path
            fillRule="evenodd"
